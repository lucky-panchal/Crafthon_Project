        ...
        <div className="px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="hidden sm:block">
              <h1 className="text-2xl font-bold tracking-tight text-white leading-tight">RakSha</h1>
              <p className="text-sm text-[#a3c45a] leading-none font-medium">Real-Time Threat Monitor</p>
            </div>
          </div>
